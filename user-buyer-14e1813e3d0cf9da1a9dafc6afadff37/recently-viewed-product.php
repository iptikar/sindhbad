...
<html lang="en">
    ...
    <head>
       ...
       <link  rel="stylesheet" type="text/css"  media="all" href="http://localhost/themes/sm_market2/pub/static/_cache/merged/82ea3d4de55c40269ad64bf293fadd23.min.css" />
        ...
        <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,d700&subset=all" rel="stylesheet" type="text/css" />
...
.label-product {
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Recently Viewed Products</span>
                        </li>
                    </ul>
                                 ...
                                 <div class="portlet-body">
                                    <div class="tabbable-bordered">
                                       ...
                                       <div class="tab-content" id="form_sample_1">
										 ...
										 <div class = "grid-produdt recently-views" id = "recently-views-2656">
										  <?php if(count($obj->RecentlyViewedProduct(0)) > 0 ) :?>
										 
										 <!-- Loop each elements --->
										 <?php foreach($obj->RecentlyViewedProduct(0) as $row) :?>
                                       ...
                                       <button type="submit" class="btn" id="upload" name="submit" onclick = "DeleteRecentlyViewProducts();">
                                       <i class="fa fa-check"></i> Delete All</button>    
                                       
                                                                     
                                    </div>
                                 
										 
										 <div class = "pagination-warper">
  ...
  <strong>Heads up!</strong> This <a href="#" class="alert-link">You have no item(s) listed under this category.
</div>
										 <?php endif; ?> 
...
<script  type="text/javascript"  src="http://localhost/js/jquery.twbsPagination.js"></script>
 <?php 
			 ...
			 $NumOfPage = $obj->GetPaginationNumPage()['NumOfPage'];
           
           // User session email address it's buyer 
           // Visible pages 
	 if($NumOfPage > 10) {
    ...
    $(function () {
        ...
        window.pagObj = $("#pagination").twbsPagination({
			...
			$.ajax({
		url: "http://localhost/ajax/recently-viewed-product.php?page="+page,
    ...
    success: function(response) {
		...
		$("#recently-views-2656").html(response);
    },
    error: function(xhr) {
