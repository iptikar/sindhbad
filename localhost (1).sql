...
--
-- Host: localhost
-- Generation Time: Feb 13, 2019 at 07:02 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `$proceurename`()
    READS SQL DATA
BEGIN SELECT * FROM product_catalogs; SELECT id + 1 FROM product_catalogs; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllOrderForSeller`()
    READS SQL DATA
BEGIN SELECT  orderdetails.order_id, 
						...
						orders.status,
						orders.id
						 FROM orderdetails INNER JOIN orders ON orderdetails.order_id = orders.order_id WHERE FROM_BASE64(orderdetails.seller_email) = 'bharatrose1@gmail.com' GROUP BY orderdetails.order_id ; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GetBuyerEmail`()
    READS SQL DATA
BEGIN SELECT buyer_email FROM orders  WHERE order_id = '201901123E18' ; SELECT id + 1 FROM orders; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getOrdersForSellers`()
    READS SQL DATA
BEGIN SELECT  orders.id, orders.order_id, orders.purchase_point, orders.purchase_date, orders.currency, orders.shipping_address, orders.billing_address, orders.totalamount, orders.status FROM orderdetails INNER JOIN orders ON orderdetails.order_id = orders.order_id WHERE FROM_BASE64(orderdetails.seller_email) = 'akashche72@gmail.com'  GROUP by orderdetails.order_id ORDER BY orderdetails.id DESC; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GetOrderStatusById`()
    READS SQL DATA
BEGIN SELECT status FROM orders  WHERE order_id = '201812182427' ; SELECT id + 1 FROM orders; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GetOrderStatusDetailsById`()
    READS SQL DATA
BEGIN SELECT status, created_at, updated_at, comments FROM orderstatus  WHERE order_id = '201812182427' ORDER BY updated_at DESC; SELECT id + 1 FROM orderstatus; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GetProductById`()
    READS SQL DATA
BEGIN SELECT  product_catalogs.id,
								...
								product_categlog_attributes.web_link FROM product_catalogs INNER JOIN product_categlog_attributes ON product_catalogs.id = product_categlog_attributes.id WHERE product_catalogs.id = '11' AND product_catalogs.sku = 'SDFSDF5656'  ; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `IfOrderStatusExists`()
    READS SQL DATA
BEGIN SELECT id FROM orderstatus  WHERE LOWER(status) = 'pending' ; SELECT id + 1 FROM orderstatus; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `OrderCart`(
																IN product_id int, 
...
BEGIN
						insert into orderdetails (product_id, prodct_name, sku, qty, price, totalamount,images, seller_email, order_id) values ('18','Original Unlocked Samsung Galaxy S8 Plus 4G R','asdfasdfasdf','1','2000 ','2000','http://localhost/img/product-images/154495371318896.jpg','am9obkBnbWFpbC5jb20=','201901123E18');
					END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `RemoveSelectProductImage`()
    READS SQL DATA
BEGIN SELECT images FROM product_catalogs  WHERE seller_email = 'bharatrose1@gmail.com' AND sku = 'ADFDF59598' ; SELECT id + 1 FROM product_catalogs; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectAllOrders`()
    READS SQL DATA
BEGIN SELECT id, order_id, purchase_point, purchase_date, currency, shipping_address, billing_address,totalamount, status FROM orders   ORDER BY purchase_date DESC; SELECT id + 1 FROM orders; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectAllProductByEmail`()
    READS SQL DATA
BEGIN SELECT id, sku, name, regular_price, avaibility FROM product_catalogs  WHERE seller_email = 'bharatrose1@gmail.com' ORDER BY id DESC; SELECT id + 1 FROM product_catalogs; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectOrderById`()
    READS SQL DATA
BEGIN SELECT id, order_id, purchase_point, purchase_date, currency, buyer_email,
										...
										status, payment, format(totalamount - shipping_cost,2) as subtotal FROM orders  WHERE order_id='201812182427' ; SELECT id + 1 FROM orders; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectOrderByIdForSeller`()
    READS SQL DATA
BEGIN SELECT  orderdetails.order_id, orderdetails.price * orderdetails.qty as totalamount,
        if(totalamount > 100 , "Free", "20") as shippingcost, (totalamount / 100) * 5 as tax FROM orderdetails  WHERE orderdetails.order_id='201812182427' AND FROM_BASE64(orderdetails.seller_email) = 'akashche72@gmail.com' GROUP BY orderdetails.order_id ; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectProductImage`()
    READS SQL DATA
BEGIN SELECT images FROM product_catalogs  WHERE sku = 'SDFSDF8956263' AND id = '3' AND seller_email = 'bharatrose1@gmail.com' ; SELECT id + 1 FROM product_catalogs; END$$
...
(1, 'sindhbad', 'sindhbad', 'admin@sindhbad.com', 'sindhbad', '$2y$10$T5q6f.HzmwlNl/JqFkRQfO0CJ7UHEOeEkmzIKzv6ff519Pm989YVi', '2018-09-16 06:19:04', '2018-09-30 05:44:27', '2018-09-30 05:44:27', 5, 0, 1, NULL, NULL, NULL, 'en_US', 0, NULL, NULL, NULL);
...
INSERT INTO `buyer` (`id`, `website`, `email`, `group_id`, `store_id`, `create_at`, `update_at`, `prifix`, `firstname`, `middlename`, `lastname`, `gender`, `customer_entitycol`, `customer_type`, `suffix`, `DOB`, `password_hash`, `password`, `rp_token`, `rp_token_created_at`, `default_shipping`, `default_billing`, `verified`) VALUES
(1, '', 'bharatrose1@gmail.com', NULL, 0, NULL, NULL, '', 'Bharat Kumar', '', 'shah', '', '', '', '', NULL, '$2y$10$GN1VazUt/UQLV6UCYNMDB.t3sLENydeZutAWzifdRCcCnnJZ7flwq', 'thisismylife', NULL, NULL, '', '', '1'),
(2, '', 'james@gmail.com', NULL, 0, NULL, NULL, '', 'James', '', 'Blunt', '', '', '', '', NULL, '$2y$10$.nuKOQPolYF4CwCJYwdJA.urRt.SgrgsRqj9gvgFLY0L7mY6Ho9ra', 'thisismylife', NULL, NULL, '', '', '0'),
(3, '', 'main@gmail.com', NULL, 0, NULL, NULL, '', 'Main', '', 'Brand', '', '', '', '', NULL, '$2y$10$QESYsjwAeRmf074BAa4dC.1l4s1.tekzRytWW11nFYhmvh1dxghR2', 'thisismylife', NULL, NULL, '', '', '0'),
(4, '', 'team@gmail.com', NULL, 0, NULL, NULL, '', 'Team', '', 'branch', '', '', '', '', NULL, '$2y$10$jjTG9eKy31GWajJtxsNZsO/dfMSWa1RRdLnQ1nrTuMoWQD2Rfmzoe', 'thisismylife', NULL, NULL, '', '', '0'),
(5, '', 'taran@gmail.com', NULL, 0, NULL, NULL, '', 'Taran', '', 'Ben', '', '', '', '', NULL, '$2y$10$cHvO0zhcky4uTf6xnagXS.cLd0jN7YV7/wOXJnvCTiNlV1qrBO0va', 'thisismylife', NULL, NULL, '', '', '0'),
(6, '', 'games@gmail.com', NULL, 0, NULL, NULL, '', 'James', '', 'Blunt', '', '', '', '', NULL, '$2y$10$C0hS7DzfGXXc6ZkeEeSuQerq4nkR8/NLL1ma2qaQNZtBSVJYg0LS6', 'thisismylife', NULL, NULL, '', '', '0'),
(7, '', 'benmark@gmail.com', NULL, 0, NULL, NULL, '', 'ben', '', 'mark', '', '', '', '', NULL, '$2y$10$7TXeJ8flsUB7Fex5rrceEeD9pnbT1wTbRlUEUtJgaAx40ZtUfAgZO', 'thisismylife', NULL, NULL, '', '', '0'),
(8, '', 'john@gmail.com', NULL, 0, NULL, NULL, '', 'john', '', 'maean', '', '', '', '', NULL, '$2y$10$5jvdbwkG5.uojvp8E1YKGexreiuB6uFQJq.RpckV6mdCogDcwFvaq', 'thisismylife', NULL, NULL, '', '', '0'),
(9, '', 'blun@gmail.com', NULL, 0, NULL, NULL, '', 'James', '', 'bliunt', '', '', '', '', NULL, '$2y$10$Y/6g0puciIugI3Vv/sdsm.w9QgWb96ftq5JIfGaJ7NKK7GQ3Wq022', 'thisismylife', NULL, NULL, '', '', '0'),
(10, '', 'bhenm@gmail.com', NULL, 0, NULL, NULL, '', 'ben', '', 'mark', '', '', '', '', NULL, '$2y$10$gsJfe5sIYLMUHffg7TiWcuAHMH32wlLacfSJWJGlESW4XyDoh6DQa', 'thisismylife', NULL, NULL, '', '', '0'),
(11, '', 'men@gmail.com', NULL, 0, NULL, NULL, '', 'james', '', 'blunt', '', '', '', '', NULL, '$2y$10$0ik5pCvjEjZC/IESLVvmheAqvvzAabF.5CM2kzaEUhFjaUQtZvzmy', 'thisismylife123', NULL, NULL, '', '', '0'),
(12, '', 'mark@gmail.com', NULL, 0, NULL, NULL, '', 'mark', '', 'bn', '', '', '', '', NULL, '$2y$10$9t3IvsfSm/zV3QCa18pZy.4HuJPqaHugGn9g.MIIiSNZSq/0W58ua', 'thisismylife', NULL, NULL, '', '', '0'),
(13, '', 'sdfmen@gmail.com', NULL, 0, NULL, NULL, '', 'men', '', 'ben', '', '', '', '', NULL, '$2y$10$.OoV06kF4Z41ib9Ru22o3ug6FW6i1oRPSR2t7kUu4L9Mop4zcxU/2', 'thisismylife', NULL, NULL, '', '', '0');
...
CREATE TABLE IF NOT EXISTS `buyer_address_details` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `buyer_address_details` (`id`, `country`, `city`, `email`, `area`, `street_no`, `building_no`, `floor_no`, `landmark`, `location_type`, `mobile_no`, `land_line_no`, `latitude`, `longititude`, `shipping_note`, `document_link`) VALUES
(1, 'AE', 'Abu Dhabi', 'bharatrose1@gmail.com', 'Al Falah Street', 'Al Falah Street', '', 'Falah Street', 'Habibi Bank', 'home', '0565973854', 0, 0, 0, 'Hello orld', NULL),
(2, 'AE', 'abhu dhbai', 'james@gmail.com', 'Al falah', 'Al Falah Street', 'Al Qusaily Tower', 'M3', 'Habibi Bank', 'home', '0565973854', 0, 0, 0, 'Nothing else matter ', NULL),
(3, 'AE', 'Abhu dhbai', 'main@gmail.com', 'Al falah', 'Al Falah Street', 'Al Qusaily Tower', 'M3', 'Habibi Bank', 'home', '0565973854', 0, 0, 0, 'Hello World ', NULL),
(4, 'AE', 'Abhu dhbai', 'team@gmail.com', 'Al falah street ', 'Al Falah Street', 'M3', 'N3', 'Habibi Bank', 'home', '0565973854', 0, 0, 0, 'Nothing else matter.', NULL),
(5, 'AE', 'Abhu dhbai', 'taran@gmail.com', 'Al falah', 'Al Falah Street', 'Al Qusaily Tower', 'M3', 'Habibi Bank', 'home', '0565973854', 0, 0, 0, 'Hello World This is Tarren ', NULL),
(6, 'AE', 'Abu dhabai', 'games@gmail.com', 'James', 'Blunt', 'Al Qusaily Tower', 'Hello', 'Habib Bank', 'home', '0522365241', 0, 0, 0, 'Do not bring this product to me.', NULL),
(7, 'AE', 'Abu dhabai', 'benmark@gmail.com', 'James', 'Blunt', 'Al Qusaily Tower', 'Hello', 'Habib Bank', 'home', '0522365241', 0, 0, 0, 'Please bring all the copy of the paper ', NULL),
(8, 'AE', 'Abu dhbai', 'john@gmail.com', 'None', '31 Street', 'Al Falah', '20', 'Habib Bank', 'home', '0525652123', 0, 0, 0, 'Do not wann buy this product ', NULL),
(9, 'AE', 'Hello', 'blun@gmail.com', 'World', 'Al Fal', 'Quasaily', 'M3', 'Habib Bank', 'home', '0565973854', 0, 0, 0, 'I love that', NULL),
(10, 'AE', 'Hello', 'bhenm@gmail.com', 'World', 'Al Fal', 'Quasaily', 'M3', 'Habib Bank', 'home', '0565973854', 0, 0, 0, '', NULL),
(11, 'AE', 'Hello', 'men@gmail.com', 'World', 'Al Fal', 'Quasaily', 'M3', 'Habib Bank', 'home', '0565973854', 0, 0, 0, 'Hello World', NULL),
(12, 'AE', 'abu dhab', 'mark@gmail.com', 'non', 'noe', 'no', '20', 'habib bank', 'business', '0522365236', 0, 0, 0, 'Noht', NULL),
(13, 'AD', 'asdfasdf', 'sdfmen@gmail.com', 'asdfa', 'asdf', 'asdf', 'asdf', 'sdf', 'business', '0522365236', 0, 0, 0, 'sdf', NULL);
...
INSERT INTO `orderdetails` (`id`, `order_id`, `created_at`, `update_at`, `buyer_email`, `seller_email`, `sku`, `product_id`, `prodct_name`, `qty`, `price`, `totalamount`, `images`, `discount`, `discount_percentage`) VALUES
(1, '201812182427', NULL, NULL, '', 'YmhhcmF0cm9zZTFAZ21haWwuY29t', 'ADFDF59598', 1, 'Unlocked Original Samsung Galaxy S8 G950 US V', 2, 3000, 6000, 'http://localhost/img/product-images/152878752620919.jpg', 0, NULL),
(2, '201812182427', NULL, NULL, '', 'am9obkBnbWFpbC5jb20=', 'asdfasdfasdf', 18, 'Original Unlocked Samsung Galaxy S8 Plus 4G R', 1, 2000, 2000, 'http://localhost/img/product-images/154495371318896.jpg', 0, NULL),
(3, '201812182427', NULL, NULL, '', 'YWthc2hjaGU3MkBnbWFpbC5jb20=', '656sdfsdf', 19, 'Original Samsung Galaxy Note 5 N920A mobile p', 1, 5000, 5000, 'http://localhost/img/product-images/154513208276044.jpg', 0, NULL),
(4, '201812191FDF', NULL, NULL, '', 'YWthc2hjaGU3MkBnbWFpbC5jb20=', '656sdfsdf', 19, 'Original Samsung Galaxy Note 5 N920A mobile p', 1, 5000, 5000, 'http://localhost/img/product-images/154513208276044.jpg', 0, NULL),
(5, '201812191FDF', NULL, NULL, '', 'am9obkBnbWFpbC5jb20=', 'asdfasdfasdf', 18, 'Original Unlocked Samsung Galaxy S8 Plus 4G R', 1, 2000, 2000, 'http://localhost/img/product-images/154495371318896.jpg', 0, NULL),
(6, '201812191FDF', NULL, NULL, '', 'YmhhcmF0cm9zZTFAZ21haWwuY29t', 'SDFSD5F656', 13, 'adidas Originals Trefoil Gym Bag', 1, 70, 70, 'http://localhost/img/product-images/152879225817334.jpg', 0, NULL),
(7, '20190112CD11', NULL, NULL, '', 'YmhhcmF0cm9zZTFAZ21haWwuY29t', 'ADFDF59598', 1, 'Unlocked Original Samsung Galaxy S8 G950 US V', 2, 3000, 6000, 'http://localhost/img/product-images/152878752620919.jpg', 0, NULL),
(8, '201901123E18', NULL, NULL, '', 'am9obkBnbWFpbC5jb20=', 'asdfasdfasdf', 18, 'Original Unlocked Samsung Galaxy S8 Plus 4G R', 1, 2000, 2000, 'http://localhost/img/product-images/154495371318896.jpg', 0, NULL);
...
INSERT INTO `orders` (`id`, `product_id`, `order_id`, `buyer_email`, `ipv4_address`, `ipv6_address`, `tax_amount`, `tax_persentage`, `discount_percentage`, `discount`, `totalqty`, `totalamount`, `currency`, `shipping_cost`, `status`, `shipping_address`, `billing_address`, `purchase_date`, `purchase_point`, `customer_notes`, `payment`, `seen`) VALUES
(1, 0, '201812182427', 'bharatrose1@gmail.com', 2130706433, NULL, 650, '5', NULL, NULL, 4, 13650, 'AED', '0', 'item_picked', '{"area":"Al Falah Street","street_no":"Al Falah Street","building_no":"","floor_no":"Falah Street","landmark":"Habibi Bank","location_type":"home","mobile_no":"0565973854","land_line_no":"0","latitude":"0","longititude":"0","shipping_note":"Hello orld","document_link":null,"country":"AE","city":"Abu Dhabi","firstname":"Bharat Kumar","lastname":"shah"}', '{"area":"Al Falah Street","street_no":"Al Falah Street","building_no":"","floor_no":"Falah Street","landmark":"Habibi Bank","location_type":"home","mobile_no":"0565973854","land_line_no":"0","latitude":"0","longititude":"0","shipping_note":"Hello orld","document_link":null,"country":"AE","city":"Abu Dhabi","firstname":"Bharat Kumar","lastname":"shah"}', '2018-12-18 16:20:40', 'sindhbad', 'Hello orld', 'pbcod', '0'),
(2, 0, '201812191FDF', 'bharatrose1@gmail.com', 2130706433, NULL, 354, '5', NULL, NULL, 3, 7424, 'AED', '0', 'inprocess', '{"area":"Al Falah Street","street_no":"Al Falah Street","building_no":"","floor_no":"Falah Street","landmark":"Habibi Bank","location_type":"home","mobile_no":"0565973854","land_line_no":"0","latitude":"0","longititude":"0","shipping_note":"Hello orld","document_link":null,"country":"AE","city":"Abu Dhabi","firstname":"Bharat Kumar","lastname":"shah"}', '', '2018-12-19 15:25:27', 'sindhbad', 'Hello orld', 'cod', '0'),
...
INSERT INTO `orderstatus` (`id`, `status`, `order_id`, `created_at`, `updated_at`, `comments`) VALUES
(1, 'pending', '201812182427', '2019-01-09 14:07:10', '2019-01-09 14:09:55', 'asdfasdf'),
(2, 'frad', '201812182427', '2019-01-09 14:10:12', '2019-01-09 14:12:20', 'asdasdf'),
(3, 'processing', '201812182427', '2019-01-09 15:02:54', '2019-01-12 16:11:00', 'We are processing'),
(4, 'confirmed', '201812182427', '2019-01-12 15:44:14', '2019-01-12 15:44:14', 'The order was cancancled'),
(5, 'item_picked', '201812182427', '2019-01-12 15:44:53', '2019-01-12 15:44:53', 'The order was cancancled'),
(6, 'created', '20190112CD11', '2019-01-12 15:59:43', '2019-01-12 15:59:43', 'asdf'),
(7, 'created', '201901123E18', '2019-01-12 16:09:44', '2019-01-12 16:09:44', '');
...
CREATE TABLE IF NOT EXISTS `product_categlog_attributes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `product_categlog_attributes` (`id`, `product_id`, `reviews`, `tag`, `youtube_link`, `facebook_link`, `web_link`, `rate`, `location_latitude`, `location_longititude`, `images`) VALUES
(1, 1, NULL, NULL, 'https://www.aliexpress.com/item/Unlocked-Original-Samsung-Galaxy-S8-G950-US-Version-Mobile-phone-4G-LTE-64GB-5-8-Inch/32920918153.html?spm=2114.search0104.3.68.5c854d502Np6DH&amp;ws_ab_test=searchweb0_0,searchweb201602_1_5729', 'https://www.aliexpress.com/item/Unlocked-Original-Samsung-Galaxy-S8-G950-US-Version-Mobile-phone-4G-LTE-64GB-5-8-Inch/32920918153.html?spm=2114.search0104.3.68.5c854d502Np6DH&amp;ws_ab_test=searchweb0_0,searchweb201602_1_5729', 'https://www.aliexpress.com/item/Unlocked-Original-Samsung-Galaxy-S8-G950-US-Version-Mobile-phone-4G-LTE-64GB-5-8-Inch/32920918153.html?spm=2114.search0104.3.68.5c854d502Np6DH&amp;ws_ab_test=searchweb0_0,searchweb201602_1_5729', NULL, 0, 0, '["152878752642392.jpg","15287875266099.jpg","152878752677508.jpg","152878752620919.jpg","152878752628483.jpg","152878752691779.jpg"]'),
(4, 4, NULL, NULL, 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', NULL, 65.965, -138.245, '["152878936595243.jpg","152878936524350.jpg","152878936572284.jpg","152878936522314.jpg","152878936596819.jpg","152878936521980.jpg"]'),
(5, 5, NULL, NULL, 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', NULL, 65.965, -138.245, '["152878963233961.jpg","152878963224483.jpg","152878963280243.jpg","152878963217308.jpg","152878963230166.jpg","152878963248230.jpg"]'),
(6, 6, NULL, NULL, 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', NULL, 65.965, -138.245, '["152879007060031.jpg","152879007015507.jpg","15287900701728.jpg","152879007069799.jpg","152879007021529.jpg","152879007096922.jpg"]'),
(8, 8, NULL, NULL, 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', NULL, 65.965, -138.245, '["152879109699032.jpg","152879109624719.jpg","152879109628069.jpg","152879109677880.jpg"]'),
(10, 10, NULL, NULL, 'http://php.net/manual/en/mysqli-stmt.affected-rows.php', 'http://php.net/manual/en/mysqli-stmt.affected-rows.php', 'http://php.net/manual/en/mysqli-stmt.affected-rows.php', NULL, 0, 0, '["152879161694715.jpg","152879161649360.jpg","152879161658721.jpg","152879161663025.jpg"]'),
(11, 11, NULL, NULL, 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', NULL, 65.965, -138.245, '["152879176957646.jpg","152879176993823.jpg","152879176938516.jpg","152879176949440.jpg","152879176953901.jpg"]'),
(13, 13, NULL, NULL, 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', 'https://www.aliexpress.com/item/Original-Unlocked-Samsung-Galaxy-S8-Plus-4G-RAM-64G-ROM-6-2-inch-Qualcomm-Octa-Core/32817292090.html?spm=2114.search0604.3.16.757c4d50iVXEcx&amp;s=p&amp;ws_ab_test=searchweb0_0,searchweb201602_', NULL, 65.965, -138.245, '["152879225817334.jpg","152879225816800.jpg","152879225834705.jpg","152879225875117.jpg","15287922585183.jpg"]'),
(15, 15, NULL, NULL, 'https://www.aliexpress.com/item/Original-Samsung-Galaxy-Note-8-6GB-RAM-64GB-ROM-6-3-inch-Octa-Core-Dual-Back/32878533743.html?spm=2114.search0104.3.1.d57ce145ufb0Qk&amp;ws_ab_test=searchweb0_0,searchweb201602_4_10152_10065_10', 'https://www.aliexpress.com/item/Original-Samsung-Galaxy-Note-8-6GB-RAM-64GB-ROM-6-3-inch-Octa-Core-Dual-Back/32878533743.html?spm=2114.search0104.3.1.d57ce145ufb0Qk&amp;ws_ab_test=searchweb0_0,searchweb201602_4_10152_10065_10', 'https://www.aliexpress.com/item/Original-Samsung-Galaxy-Note-8-6GB-RAM-64GB-ROM-6-3-inch-Octa-Core-Dual-Back/32878533743.html?spm=2114.search0104.3.1.d57ce145ufb0Qk&amp;ws_ab_test=searchweb0_0,searchweb201602_4_10152_10065_10', NULL, -50.8952, 5.31875, '["153182917523260.jpg","153182917597022.jpg","153182917564189.jpg","153182917546888.jpg","153182917525509.jpg"]'),
(16, 16, NULL, NULL, '', '', '', NULL, -50.8952, 5.31875, '["153183025299455.jpg","153183025212726.jpg","153183025295739.jpg"]'),
(17, 17, NULL, NULL, '', '', '', NULL, -50.8952, 5.31875, '["153225999830025.jpg","153225999897629.jpg"]');
...
INSERT INTO `recently_viewed_product` (`id`, `email`, `seen`, `product_sku`, `product_category_id`) VALUES
(12, 'bharatrose1@gmail.com', '2018-09-27 13:05:11', 'SDFSDF956', 52),
(21, 'bharatrose1@gmail.com', '2018-07-31 16:13:35', 'SDF6565656', 52),
(22, 'bharatrose1@gmail.com', '2018-07-31 16:13:42', 'SDFSDF253', 52),
(23, 'bharatrose1@gmail.com', '2018-12-17 12:59:34', 'SDFSDF5656', 52),
(24, 'bharatrose1@gmail.com', '2018-10-01 12:38:09', 'SDFSDF215545', 52),
(25, 'bharatrose1@gmail.com', '2018-10-01 12:38:23', 'SDFSDDF852', 52),
(35, 'akashche72@gmail.com', '2018-09-26 13:48:30', '589SDFDF', 314),
(36, 'akashche72@gmail.com', '2018-08-01 15:21:48', 'SDFSDF8956263', 314),
(37, 'akashche72@gmail.com', '2018-09-22 12:45:33', 'SDFSDF522', 314),
(38, 'akashche72@gmail.com', '2018-09-25 13:56:41', 'ADFDF59598', 314),
(39, 'akashche72@gmail.com', '2018-09-10 16:21:02', 'SDFSDF956', 52),
(40, 'akashche72@gmail.com', '2018-09-22 12:45:45', 'SDFSDDF852', 52),
(41, 'akashche72@gmail.com', '2018-09-19 13:36:08', 'SSDF65656', 314),
(42, 'akashche72@gmail.com', '2018-09-24 13:25:22', 'SDF6565656', 52),
(43, 'bharatrose1@gmail.com', '2018-12-18 15:28:46', 'ADFDF59598', 314),
(44, 'bharatrose1@gmail.com', '2018-11-03 15:56:05', '589SDFDF', 314),
(45, 'bharatrose1@gmail.com', '2018-10-01 12:38:58', 'SDFSDF8956263', 314),
(46, 'bharatrose1@gmail.com', '2018-10-01 12:40:01', 'SDFDF5200', 314),
(47, 'taran@gmail.com', '2018-10-02 12:09:30', '589SDFDF', 314),
(48, 'taran@gmail.com', '2018-10-01 12:43:46', 'SDFSDF522', 314),
(49, 'taran@gmail.com', '2018-10-01 12:44:15', 'ADFDF59598', 314),
(50, 'bharatrose1@gmail.com', '2018-12-18 15:39:52', 'asdfasdfasdf', 314),
(51, 'bharatrose1@gmail.com', '2018-12-18 15:40:02', '656sdfsdf', 314);
...
INSERT INTO `review` (`id`, `review_id`, `buyer_email`, `create_at`, `updated_at`) VALUES
(1, '15448779575c14f7855836a', 'bharatrose1@gmail.com', '2018-12-15', '2018-12-15'),
(2, '15450470875c178c2f18593', 'bharatrose1@gmail.com', '2018-12-17', '2018-12-17'),
(3, '15450471715c178c83efe54', 'bharatrose1@gmail.com', '2018-12-17', '2018-12-17'),
(4, '15450472615c178cddd0609', 'bharatrose1@gmail.com', '2018-12-17', '2018-12-17'),
(5, '15450473155c178d13aba9e', 'bharatrose1@gmail.com', '2018-12-17', '2018-12-17'),
(6, '15450473885c178d5c5fc75', 'bharatrose1@gmail.com', '2018-12-17', '2018-12-17');
...
INSERT INTO `review_details` (`id`, `product_id`, `review_id`, `title`, `good`, `bad`, `details`, `sku`, `seller_email`, `buyer_email`, `recomanded`, `stars`, `created_at`, `updated_at`) VALUES
(1, 1, '15448779575c14f7855836a', '', 'adfadf', 'asdfasdf', '', 'ADFDF59598', NULL, 'bharatrose1@gmail.com', '', 3, '2018-12-15', '2018-12-15'),
(2, 18, '15450470875c178c2f18593', '', 'Really nice Product', 'I relly do not need ', '', 'asdfasdfasdf', NULL, 'bharatrose1@gmail.com', '', 3, '2018-12-17', '2018-12-17'),
(3, 18, '15450471715c178c83efe54', '', 'I will buy another', 'yes really ', '', 'asdfasdfasdf', NULL, 'bharatrose1@gmail.com', '', 4, '2018-12-17', '2018-12-17'),
(4, 18, '15450472615c178cddd0609', '', 'Thank you for the product', 'nothing', '', 'asdfasdfasdf', NULL, 'bharatrose1@gmail.com', '', 5, '2018-12-17', '2018-12-17'),
(5, 18, '15450473155c178d13aba9e', '', 'Naina', 'thak le gan', 'Hello woorld', 'asdfasdfasdf', NULL, 'bharatrose1@gmail.com', '', 4, '2018-12-17', '2018-12-17'),
(6, 18, '15450473885c178d5c5fc75', '', 'whole l', 'sdf', '', 'asdfasdfasdf', NULL, 'bharatrose1@gmail.com', '', 3, '2018-12-17', '2018-12-17');
...
INSERT INTO `seller` (`id`, `website`, `email`, `group_id`, `store_id`, `seller_id`, `create_at`, `update_at`, `prifix`, `firstname`, `middlename`, `lastname`, `gender`, `customer_entitycol`, `customer_type`, `suffix`, `DOB`, `seller_type`, `password_hash`, `password`, `rp_token`, `rp_token_created_at`, `default_shipping`, `default_billing`, `tax_vat_number`, `verified`) VALUES
(1, '', 'bharatrose1@gmail.com', NULL, '1421344913e512097cea79bc62a28db7ab884fa0', '', '2018-07-15 13:27:18', NULL, '', 'bharrat', '', 'shah', '', '', '1', '', NULL, '', '$2y$10$wq9Bk0mLkOC4j52iCRbpHe4tYJ.92KoTBUASdPt5k71pUh.LPjvZK', 'ThisIsMyLife123', NULL, NULL, '', '', NULL, '1'),
(2, '', 'akashche72@gmail.com', NULL, '8927ebc4b295f4ee723add7e34d284d709577def', '', '2018-07-15 13:29:09', NULL, '', 'akashche', '', 'chec', '', '', '1', '', NULL, '', '$2y$10$2pVm29cxkqbJdmfNBx1x6.GqC.FeWApwYQGv5pMzFPuY2LUw0/KYu', 'ThisIsMyLife123', NULL, NULL, '', '', NULL, '1'),
(3, '', 'bharatrose1@yahoo.com', NULL, '63b8cd49b6853ab9e01eeaa47e4c873e705c1cd5', '', '2018-11-21 13:22:02', NULL, '', 'Ron', '', 'John', '', '', '1', '', NULL, '', '$2y$10$axvmeQey4UtIBwrkrWntK.H0U9vsDQXVoaxahBH3bM9v2SvAzn9SG', 'ThisIsMyLife123', NULL, NULL, '', '', NULL, '1'),
(4, '', 'john@gmail.com', NULL, '3ed1f057a04454b379301dee844f753f8b6c673b', '', '2018-11-21 13:39:02', NULL, '', 'Hello', '', 'world', '', '', '1', '', NULL, '', '$2y$10$wq9Bk0mLkOC4j52iCRbpHe4tYJ.92KoTBUASdPt5k71pUh.LPjvZK', 'ThisIsMyLife123', NULL, NULL, '', '', NULL, '1'),
(5, '', 'bharatrose2@gmail.com', NULL, '7d04cec20b701944820614085271ecf644a8ca13', '', '2018-11-21 16:47:43', NULL, '', 'new', '', 'client', '', '', '1', '', NULL, '', '$2y$10$B2keayf/y2EYYsVI1kqeuuAqw3UaSGWHRzS6AY7QNk88YFtPstpxy', 'ThisIsMyLife123', NULL, NULL, '', '', NULL, '1'),
(6, '', 'hello@gmail.com', NULL, '426735e0c3ee1e5b05a5584ee7a2ad0ffcdd7e4f', '', '2018-11-24 13:41:22', NULL, '', 'Hello', '', 'World', '', '', '1', '', NULL, '', '$2y$10$Vs0MRhCKUCRdt9e7kE4VlOpAXS3Rxj/rKX72U/tW6PwVstcTu3/Y2', 'ThisIsMyLife123', NULL, NULL, '', '', NULL, '1');
...
INSERT INTO `seller_address` (`id`, `parent_id`, `created_at`, `update_at`, `verified`, `city`, `company`, `contry_id`, `fax`, `firstname`, `middlename`, `lastname`, `postcode`, `prefix`, `region`, `region_id`, `street`, `suffix`, `telephone`, `customer_address_entitycol`, `customer_address_entitycol1`, `TRN`, `vat_id`, `vat_is_valid`, `vat_request_id`, `vat_request_success`) VALUES
(1, 0, '2018-07-15 13:27:18', NULL, '0', '', '', '', '', 'bharrat', '', 'shah', '', '', '', NULL, '', '', '', '', '', '', '', '0', '', NULL),
(2, 0, '2018-07-15 13:29:09', NULL, '0', '', '', '', '', 'akashche', '', 'chec', '', '', '', NULL, '', '', '', '', '', '', '', '0', '', NULL);
...
CREATE TABLE IF NOT EXISTS `seller_address_details` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `country` varchar(45) NOT NULL,
  `city` char(40) NOT NULL,
  `email` varchar(45) NOT NULL,
...
INSERT INTO `seller_address_details` (`id`, `country`, `city`, `email`, `area`, `street_no`, `building_no`, `floor_no`, `landmark`, `location_type`, `mobile_no`, `land_line_no`, `latitude`, `longititude`, `shipping_note`, `document_link`) VALUES
(1, '', '', 'john@gmail.com', NULL, '', '', '', '', '', 0, NULL, 0, 0, NULL, NULL),
(2, '', '', 'bharatrose2@gmail.com', NULL, '', '', '', '', '', 0, NULL, 0, 0, NULL, NULL),
(3, '', '', 'hello@gmail.com', NULL, '', '', '', '', '', 0, NULL, 0, 0, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `seller_as_company` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `seller_as_company` (`id`, `business_name`, `legal_form`, `nationality`, `established`, `expiry_date`, `company_type`, `tax_no`, `registration_no`, `country`, `city`, `telephone`, `mobile_no`, `po_box`, `fax`, `website`, `latitude`, `longitude`, `address`, `unique_business_id`, `seller_type`, `document`, `created`, `updated`, `seller_email`) VALUES
(1, 'Iptikar Distribution', 'Legal', 'Emirati', '2018-10-31', '2018-11-14', 'Single', '56565656', '5656565', 'AS', 'Abu Dhabi', '+971502365236', '+971502365236', 5656, '', 'http://www.iptikar.com/', '50.89519900', '5.31875000', 'Al Falsh Street, Abu Dhbai, UAE', 'Iptikar123', 'retails', NULL, '2018-11-20', '2018-11-21', 'akashche72@gmail.com'),
(2, 'Icon Advertising', 'Legal', 'Jordian', '2018-07-09', '2019-04-17', 'Advertising', '2565656', '5565656', 'AT', 'Abu Dhabi', '+971656565656', '+97105223652', 5622, '', 'http://www.icon-ad.com', '-50.89519900', '5.31875000', 'Silicon osis dubai', 'Icon-ad', 'retails', NULL, '2018-11-21', '2018-11-21', 'bharatrose1@yahoo.com'),
(3, 'Dihead Advertising LLC', 'Legal', 'Jordian', '2018-09-02', '2019-07-20', 'FMGC', '123456789', '123456789', 'AE', 'Al Ain', '+97155656560', '+97155656560', 59895, '78550', 'http://www.icon-ad.com', '5.58989900', '5.58989900', 'Al Falah Street', 'iconad', 'retails', NULL, '2018-11-21', '2018-11-21', 'john@gmail.com'),
(4, 'Iptikar Distribution', 'Legal', 'Emirati', '2018-10-31', '2018-12-20', 'Single', '56565656', '5656565', 'AX', 'Abu Dhabi', '+97150236523', '+97150236523', 5656, '595656', 'http://www.soqu.com/', '50.89519900', '5.31875000', 'Al Falsh Street, Abu Dhbai, UAE', 'asdfasdfasdf', 'retails', NULL, '2018-11-21', '2018-11-21', 'bharatrose2@gmail.com');
...
CREATE TABLE IF NOT EXISTS `seller_as_individual` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `seller_as_individual` (`id`, `country`, `city`, `state_region_province`, `post_zip_code`, `land_line_no`, `mobile_no`, `nationality`, `emirate_id_no`, `unique_business_id`, `seller_type`, `website`, `address`, `document`, `seller_email`, `created`, `updated`) VALUES
(1, 'AR', 'Abu Dhabi', 'Abu dhabi', 50023, '+971565973855', '+971565973855', 'angolan', '598598685656', 'Iptikar123', 'retails', 'http://www.soqu.com/', 'Al Falsh Street, Abu Dhbai, UAE', '', 'bharatrose1@gmail.com', '2018-11-19', '2018-11-21');
...
ALTER TABLE `buyer_address`
  ADD CONSTRAINT `buyer_address_ibfk_1` FOREIGN KEY (`id`) REFERENCES `buyer` (`id`);

--
-- Constraints for table `buyer_address_details`
--
ALTER TABLE `buyer_address_details`
  ADD CONSTRAINT `buyer_address_details_ibfk_1` FOREIGN KEY (`id`) REFERENCES `buyer` (`id`);
...
ALTER TABLE `orderstatus`
  ADD CONSTRAINT `orderstatus_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`);

--
-- Constraints for table `product_catalogs`
--
ALTER TABLE `product_catalogs`
  ADD CONSTRAINT `product_catalogs_ibfk_1` FOREIGN KEY (`seller_email`) REFERENCES `seller` (`email`);

--
-- Constraints for table `product_categlog_attributes`
--
ALTER TABLE `product_categlog_attributes`
  ADD CONSTRAINT `product_categlog_attributes_ibfk_1` FOREIGN KEY (`id`) REFERENCES `product_catalogs` (`id`);

--
-- Constraints for table `recently_viewed_product`
--
ALTER TABLE `recently_viewed_product`
  ADD CONSTRAINT `recently_viewed_product_ibfk_1` FOREIGN KEY (`email`) REFERENCES `buyer` (`email`);

--
-- Constraints for table `review`
--
ALTER TABLE `review`
  ADD CONSTRAINT `review_ibfk_1` FOREIGN KEY (`buyer_email`) REFERENCES `buyer` (`email`);

--
-- Constraints for table `review_details`
--
ALTER TABLE `review_details`
  ADD CONSTRAINT `review_details_ibfk_1` FOREIGN KEY (`review_id`) REFERENCES `review` (`review_id`),
  ADD CONSTRAINT `review_details_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product_catalogs` (`id`),
  ADD CONSTRAINT `review_details_ibfk_3` FOREIGN KEY (`seller_email`) REFERENCES `seller` (`email`);

--
-- Constraints for table `seller_address`
--
ALTER TABLE `seller_address`
  ADD CONSTRAINT `seller_address_ibfk_1` FOREIGN KEY (`id`) REFERENCES `seller` (`id`);

--
-- Constraints for table `seller_address_details`
--
ALTER TABLE `seller_address_details`
  ADD CONSTRAINT `seller_address_details_ibfk_1` FOREIGN KEY (`id`) REFERENCES `seller` (`id`);

--
-- Constraints for table `seller_as_company`
--
ALTER TABLE `seller_as_company`
  ADD CONSTRAINT `seller_as_company_ibfk_1` FOREIGN KEY (`seller_email`) REFERENCES `seller` (`email`);

--
-- Constraints for table `seller_as_individual`
--
ALTER TABLE `seller_as_individual`
  ADD CONSTRAINT `seller_as_individual_ibfk_1` FOREIGN KEY (`seller_email`) REFERENCES `seller` (`email`);
