...
class DowGroup {
    ...
    public function FinalUploadFiles($filename)
    {
        ...
        $sql = "INSERT INTO files(cagtegory_id, name, about, created, updated)VALUES('$category_id', '$names', '$about', NOW(), NOW())";
    ...
    public function GetUsers() {
     ...
     public function GetFiles() {
		...
		$sql = "select files.name as files , files.id, files.cagtegory_id, file_categories.name from files INNER JOIN file_categories ON files.cagtegory_id = file_categories.id";
        ...
        */
        ...
        public function addFileCategory() {
            ...
            if(isset($_POST['add-category'])) {
                ...
                // Insert 
                $sql = "INSERT INTO file_categories(name, created, updated)VALUES('$name', NOW(), NOW())";
