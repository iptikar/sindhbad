...
class SelectStoreProcedure
{
    ...
    // With joins 
    public static function SelectRecordsByStoreProcedureWithJoin(
            mysqli $mysqli,
                                                            string $tablename,
                                                            string $proceurename,
                                                            string $requiredColums,
        ...
        if (!$mysqli->query("DROP PROCEDURE IF EXISTS $proceurename") ||
                        ...
                        !$mysqli->query("CREATE PROCEDURE $proceurename() READS SQL DATA BEGIN SELECT  $requiredColums FROM $tablename $join $where $orderby ; END;")) {
            $result['result'] = "Stored procedure creation failed: (" . $mysqli->errno . ") " . $mysqli->error. "Line No ".__LINE__;
      ...
      // With Group By
    public static function SelectRecordsByStoreProcedureWithJoinWithGroup(
            mysqli $mysqli,
                                                            string $tablename,
                                                            string $proceurename,
                                                            string $requiredColums,
        ...
        if (!$mysqli->query("DROP PROCEDURE IF EXISTS $proceurename") ||
                        ...
                        !$mysqli->query("CREATE PROCEDURE $proceurename() READS SQL DATA BEGIN SELECT  $requiredColums FROM $tablename $join $where $groupby $orderby; END;")) {
