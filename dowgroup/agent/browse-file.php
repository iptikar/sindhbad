...
Message Send Successfully.
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">/<?=$_GET['name']?></h6>
            </div>
            <div class="card-body">
...
<?php foreach($obj->getFilesFromFolder('name') as $key => $value) :?>

<button class="btn"><i class="fa fa-download"></i> <a href = "<?= $value?>" download >Download File</a></button> <br/>
<br/>
