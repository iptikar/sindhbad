  ...
  <?php
    ...
    $(function () {
        ...
        window.pagObj = $("#pagination").twbsPagination({
			...
			$.ajax({
		url: "http://localhost/ajax/category-pages.php?page="+page+"&category_name='.$category_name.'&category_id='.$category_id.'",
                  ...
                  <div class="row">
                     <div class="col-lg-9 col-md-9 col-right-main">
                        ...
                        <div class="column main">
                          ...
                          <?php if($obj->GetProductByCategoryList('category_name', 'category_id', 0, $obj->perpage) !== false) :?>     
                         
			
						<!---  -->
						<?php foreach ($obj->GetProductByCategoryList('category_name', 'category_id', 0, $obj->perpage) as $row) :?>
