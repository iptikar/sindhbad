...
*/
		...
		$child_elment .= '<div class="sidebar-name '.$is_active.'"">
                <!-- Pass username and display name to register popup -->
                <a href="javascript:register_popup('.$row->sender.', '.$row->sender.');">
                    <img width="30" height="30" src="http://localhost/chat/img/avatar.png" />
