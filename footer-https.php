                           ...
                           <div class="row">
                              <div class="col-lg-4 col-md-4">
                                 <div class="socials-wrap">
                                    ...
                                    <ul>
                                       <li class="li-social facebook-social"><a title="Facebook" href="https://www.facebook.com/#" target="_blank"><span class="fa fa-facebook icon-social"></span><span class="name-social">Facebook</span></a></li>
                                       <li class="li-social twitter-social"><a title="Twitter" href="httpss://twitter.com/#" target="_blank"><span class="fa fa-twitter icon-social"></span> <span class="name-social">Twitter</span></a></li>
                                       <li class="li-social google-social"><a title="Google+" href="httpss://plus.google.com/u/0/+Smartaddons" target="_blank"><span class="fa fa-google-plus icon-social"></span> <span class="name-social">Google+</span></a></li>
                                       ...
                                       <div class="footer-block">
                                          ...
                                          <div class="footer-block-content">
                                             <ul class="links-footer">
                                                <li><a title="About Us" href="https://localhost/themes/sm_market2/argentina/about-us.html">About Us</a></li>
                                       ...
                                       <div class="footer-block">
                                          ...
                                          <div class="footer-block-content">
                                             <ul class="links-footer">
                                                ...
                                                <li><a title="My Account" href="https://localhost/themes/sm_market2/argentina/customer/account">My Account</a></li>
                                                <li><a title="Return Policy" href="#">Return Policy</a></li>
                                                <li><a title="Contact Us" href="https://localhost/themes/sm_market2/argentina/contact-us.html">Contact Us</a></li>
                                             </ul>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="container">
                           <div class="row">
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 footer-payment">
                                 ...
                                 <html>
                                    <body>
                                       <div class="lazyload-container"><img src="https://localhost/img/blank.png" alt="Payment" data-src="https://localhost/img/payment.png" class=" lazyload "></div>
                                    </body>
                                 </html>
                              </div>
                           </div>
...
<script>
 ...
 <script src = "https://localhost/js/xzoom.min.js"></script>
      <script src = "https://localhost/js/hammer.min.js"></script>
      <script src = "https://localhost/js/foundation.min.js"></script>
      <script src = "https://localhost/js/zoom1.js"></script>
     <script src = "https://localhost/js/custom.js"></script>
 ...
 <script>
  window.authenticationPopup = {"autocomplete":"off","customerRegisterUrl":"https:\/\/magento2.flytheme.net\/themes\/sm_market2\/argentina\/customer\/account\/create\/","customerForgotPasswordUrl":"https:\/\/magento2.flytheme.net\/themes\/sm_market2\/argentina\/customer\/account\/forgotpassword\/","baseUrl":"https:\/\/magento2.flytheme.net\/themes\/sm_market2\/argentina\/"};
</script>
