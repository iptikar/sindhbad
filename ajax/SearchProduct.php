...
<?php if(count(SearchProducts::LetMeSearchProducts('q', 'cat', $_GET['page'], $obj->perpage)['result']) > 0) :?>  

<?php foreach (SearchProducts::LetMeSearchProducts('q', 'cat', $_GET['page'], $obj->perpage)['result'] as $row) :?>
