   ...
   <?php foreach ($data as $item) { ?>      
      ...
      <td>
        <form method="DELETE" action="<?php echo base_url('index.php/itemCRUD/delete/'.$item->id);?>">
          <a class="btn btn-info" href="<?php echo base_url('index.php/itemCRUD/'.$item->id) ?>"> show</a>

 
         <a class="btn btn-primary" href="<?php echo base_url('index.php/itemCRUD/edit/'.$item->id) ?>"> Edit</a>
