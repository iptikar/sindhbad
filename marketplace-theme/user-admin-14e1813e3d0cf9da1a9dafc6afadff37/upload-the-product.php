         ...
         <body class = "page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
            ...
            <div class = "page-header navbar navbar-fixed-top">
               ...
               <div class = "page-header-inner ">
                  ...
                  <div class = "page-logo">
                     <a href = "index.html">
                     <img src = "http://localhost/htdocs/metronic/theme/assets/layouts/layout4/img/logo-light.png" alt = "logo" class = "logo-default" /> </a>
                                          ...
                                          <div class = "tab-pane active" id = "tab_general">
                                             <div class = "form-body">
                                                ...
                                                <div class = "form-group">
                                                   ...
                                                   <div class = "col-md-10">
                                                      <textarea class = "form-control" id = "discription" name = "discription" ><?php echo $_POST['discription'] ?? ''; ?></textarea>
                                                   </div>
                                                </div>
                                                <div class = "form-group">
                                                   ...
                                                   <div class = "col-md-10">
                                                      <textarea class = "form-control" name = "short-discription" id = "short-discription"><?php echo $_POST['short-discription'] ?? ''; ?></textarea>
                                                ...
                                                <div class = "form-group">
                                                   ...
                                                   <div class = "col-md-4">
                                                      <div class = "input-group input-large date-picker input-daterange" data-date = "10/11/2012" data-date-format = "mm/dd/yyyy">
                                                         ...
                                                         <input type = "text" class = "form-control" name = "date-available-from" id = "date-available-from" value = "<?php echo $_POST['date-available-from'] ?? ''; ?>" />
                                                        
                                                         <span class = "input-group-addon"> to </span>
                                                        
                                                         <input type = "text" class = "form-control" name = "date-available-to" id = "date-available-to" value = "<?php echo $_POST['date-available-to'] ?? ''; ?>" />
                                                      </div>
                                                ...
                                                <div class = "form-group">
                                                   ...
                                                   <div class = "col-md-4">
                                                      <select id = "avaibility" class = "form-control" name  =  "avaibility">
                                                         <option value = "">Avaibility</option>
                                                ...
                                                <div class = "form-group">
                                                   ...
                                                   <div class = "col-md-4">
                                                      <input type = "text" class = "form-control" name = "shipping cost" placeholder = "Free Shipping"  value = "<?php echo $_POST['shipping cost'] ?? ''; ?>"> 
                                                   </div>
                                                </div>
                                                <div class = "form-group">
                                               ...
                                               <div class  =  "form-group">
                                                ...
                                                <label class = "col-md-2 control-label">Delivery Service <span class = "required"> * </span></label>
                                                      ...
                                                      <div class  =  "col-md-1">
                                                      <input type = "radio" name = "delivery-service" value = "pick up" id  =  "pick up" class  =  "form-control" value = "<?php  $_POST['delivery-service'] === 'pick up' ? 'checked': ''; ?>" />
                                                      </div>
                                                      
                                                     <label class = "col-md-2 control-label" for  =  "sindbad">By Sindbad</label>
                                                     
                                                     <div class  =  "col-md-1">
                                                      <input type = "radio" name = "delivery-service" value = "sindbad" id  =  "sindbad" class  =  "form-control" value = "<?php  $_POST['delivery-service'] === 'sindbad'? 'checked': ''; ?>">
                                                      </div>
                                               </div>
                                                ...
                                                <div class  =  "added-images" style  =  "min-height:175px;">
            ...
            <script src = "js/dynamic-fields.js" type = "text/javascript"></script>
...
btn.onclick = function() {
	...
	document.getElementById("error-message").innerHTML="someContent"; 
...
window.onclick = function(event) {
    if (event.target == modal) {
      ...
      if($obj->IsFormSubmitted() === true ) {
		  ...
		  // Check if validation returning other then true 
