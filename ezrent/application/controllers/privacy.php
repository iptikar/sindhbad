...
class Privacy extends CI_Controller {
    ...
    public function index(){
		...
		$data['terms'] = $this->front_model->getRecord('dynamic_pages',array('id_dynamic_pages'=>5));
		...
		//
		$data['seo'] = $this->front_model->getRecord('static_seo_pages',array('id_static_seo_pages'=>13),TRUE);
		//
		$this->template->write_view("header","front/header",$header);
		$this->template->write_view("content","front/terms",$data);
