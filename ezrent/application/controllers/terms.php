...
class Terms extends CI_Controller {
    ...
    public function index(){
		...
		$data['terms'] = $this->front_model->getRecord('dynamic_pages',array('id_dynamic_pages'=>4));
		...
		//
		$data['seo'] = $this->front_model->getRecord('static_seo_pages',array('id_static_seo_pages'=>12),TRUE);
		//
