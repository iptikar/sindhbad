...
window.location="<?= site_url("back_office/static_translations/delete"); ?>/"+id;
return false;
}
...
$("#result").load("<?= site_url("back_office/static_translations/sorted"); ?>"+"?"+ser);
}
});
...
<li class="pull-right">
<a href="<?= site_url('back_office/static_translations/add'); ?>" id="topLink" class="btn btn-info top_btn" title="">Add static translations</a>
</li><? } ?>
</ul> 
</div>
...
<h4>Filter by</h4>
<form method="get" action="<?=site_url("back_office/static_translations")?>">
<div class="fl" style="margin:0 15px 0 0;width: 230px; float:left;">Title<br /><input type="text" id="title" name="title" value="<? if($this->input->get("title") != "") { echo $this->input->get("title"); }?>" /></div>
...
echo form_open_multipart('back_office/static_translations/delete_all', $attributes); 
?>  		
...
<td width="2%">&nbsp;</td>
<th>
<a href="<?= site_url('back_office/static_translations/index/title'); ?>" class="<? if($sego == "title") echo 'green'; else echo 'order_link'; ?>" >
TITLE
</a>
...
$i++; 
?>
<tr id="<?=$val["id_static_translations"]; ?>">
<td class="col-chk"><input type="checkbox" name="cehcklist[]" value="<?= $val["id_static_translations"] ; ?>" /></td>
...
<a href="<?= site_url('back_office/translation/section/static_translations/'.$val["id_static_translations"]);?>" class="table-edit-link" title="Translate" >
<i class="icon-search" ></i> Translate</a> <span class="hidden"> | </span>
<? } 
}?><? if ($this->acl->has_permission('static_translations','index')){ ?>
<a href="<?= site_url('back_office/static_translations/view/'.$val["id_static_translations"]);?>" class="table-edit-link" title="View" >
<i class="icon-search" ></i> View</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('static_translations','edit')){ ?>
<a href="<?= site_url('back_office/static_translations/edit/'.$val["id_static_translations"]);?>" class="table-edit-link" title="Edit" >
<i class="icon-edit" ></i> Edit</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('static_translations','delete')){ ?>
<a onclick="if(confirm('Are you sure you want delete this item ?')){ delete_row('<?=$val["id_static_translations"];?>'); }" class="table-delete-link cur" title="Delete" >
...
<form action="<?= site_url("back_office/static_translations"); ?>" method="post"  id="show_items">
Show Items&nbsp;
