...
window.location="<?= site_url("back_office/our_value/delete"); ?>/"+id;
return false;
}
...
$("#result").load("<?= site_url("back_office/our_value/sorted"); ?>"+"?"+ser);
}
});
...
<li class="pull-right">
<a href="<?= site_url('back_office/our_value/add'); ?>" id="topLink" class="btn btn-info top_btn" title="">Add our value</a>
</li><? } ?>
</ul> 
</div>
...
echo form_open_multipart('back_office/our_value/delete_all', $attributes); 
?>  		
...
<td width="2%">&nbsp;</td>
<th>
<a href="<?= site_url('back_office/our_value/index/title'); ?>" class="<? if($sego == "title") echo 'green'; else echo 'order_link'; ?>" >
TITLE
</a>
...
$i++; 
?>
<tr id="<?=$val["id_our_value"]; ?>">
<td class="col-chk"><input type="checkbox" name="cehcklist[]" value="<?= $val["id_our_value"] ; ?>" /></td>
<td class="title_search">
<? echo $val["title".$lang]; ?>
</td>
<td style="text-align:center"><? if ($this->acl->has_permission('our_value','index')){ ?>
<a href="<?= site_url('back_office/our_value/view/'.$val["id_our_value"]);?>" class="table-edit-link" title="View" >
<i class="icon-search" ></i> View</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('our_value','edit')){ ?>
<a href="<?= site_url('back_office/our_value/edit/'.$val["id_our_value"]);?>" class="table-edit-link" title="Edit" >
<i class="icon-edit" ></i> Edit</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('our_value','delete')){ ?>
<a onclick="if(confirm('Are you sure you want delete this item ?')){ delete_row('<?=$val["id_our_value"];?>'); }" class="table-delete-link cur" title="Delete" >
...
<form action="<?= site_url("back_office/our_value"); ?>" method="post"  id="show_items">
Show Items&nbsp;
