...
window.location="<?= site_url("back_office/dynamic_pages/delete"); ?>/"+id;
return false;
}
...
$("#result").load("<?= site_url("back_office/dynamic_pages/sorted"); ?>"+"?"+ser);
}
});
...
<li class="pull-right">
<a href="<?= site_url('back_office/dynamic_pages/add'); ?>" id="topLink" class="btn btn-info top_btn" title="">Add dynamic pages</a>
</li><? } ?>
</ul> 
</div>
...
echo form_open_multipart('back_office/dynamic_pages/delete_all', $attributes); 
?>  		
...
<td width="2%">&nbsp;</td>
<th>
<a href="<?= site_url('back_office/dynamic_pages/index/title'); ?>" class="<? if($sego == "title") echo 'green'; else echo 'order_link'; ?>" >
TITLE
</a>
...
<td style="text-align:center"><? if ($this->acl->has_permission('dynamic_pages','index')){ ?>
<a href="<?= site_url('back_office/dynamic_pages/view/'.$val["id_dynamic_pages"]);?>" class="table-edit-link" title="View" >
<i class="icon-search" ></i> View</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('dynamic_pages','edit')){ ?>
<a href="<?= site_url('back_office/dynamic_pages/edit/'.$val["id_dynamic_pages"]);?>" class="table-edit-link" title="Edit" >
<i class="icon-edit" ></i> Edit</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('dynamic_pages','delete')){ ?>
<a onclick="if(confirm('Are you sure you want delete this item ?')){ delete_row('<?=$val["id_dynamic_pages"];?>'); }" class="table-delete-link cur" title="Delete" >
...
<form action="<?= site_url("back_office/dynamic_pages"); ?>" method="post"  id="show_items">
Show Items&nbsp;
