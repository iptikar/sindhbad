...
window.location="<?= site_url("back_office/blog/delete"); ?>/"+id;
return false;
}
...
$("#result").load("<?= site_url("back_office/blog/sorted"); ?>"+"?"+ser);
}
});
...
<li class="pull-right">
<a href="<?= site_url('back_office/blog/add'); ?>" id="topLink" class="btn btn-info top_btn" title="">Add blog</a>
</li><? } ?>
</ul> 
</div>
...
echo form_open_multipart('back_office/blog/delete_all', $attributes); 
?>  		
...
<td width="2%">&nbsp;</td>
<th>
<a href="<?= site_url('back_office/blog/index/title'); ?>" class="<? if($sego == "title") echo 'green'; else echo 'order_link'; ?>" >
TITLE
</a>
</th>
<th>
<a href="<?= site_url('back_office/blog/index/is_popular'); ?>" class="<? if($sego == "is_popular") echo 'order_active'; else echo 'order_link'; ?>" >
IS POPULAR
</a>
...
?>
<tr id="<?=$val["id_blog"]; ?>">
<td class="col-chk"><input type="checkbox" name="cehcklist[]" value="<?= $val["id_blog"] ; ?>" /></td>
...
<td style="text-align:center"><? if ($this->acl->has_permission('blog','index')){ ?>
<a href="<?= site_url('back_office/blog/view/'.$val["id_blog"]);?>" class="table-edit-link" title="View" >
<i class="icon-search" ></i> View</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('blog','edit')){ ?>
<a href="<?= site_url('back_office/blog/edit/'.$val["id_blog"]);?>" class="table-edit-link" title="Edit" >
<i class="icon-edit" ></i> Edit</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('blog','delete')){ ?>
<a onclick="if(confirm('Are you sure you want delete this item ?')){ delete_row('<?=$val["id_blog"];?>'); }" class="table-delete-link cur" title="Delete" >
...
<form action="<?= site_url("back_office/blog"); ?>" method="post"  id="show_items">
Show Items&nbsp;
