...
$ul = array(
            anchor('back_office/faq/'.$this->session->userdata("back_link"),'<b>List faq</b>').'<span class="divider">/</span>',
            $title => array('li_attributes' => 'class = "active"', 'contents' => $title),
            );
if($this->config->item("language_module") && isset($id)) {
			   $ul['translate'] = array('li_attributes' => 'class = "pull-right"', 'contents' => '<a href="'.site_url('back_office/translation/section/faq/'.$id).'" class="btn btn-info top_btn">Translate</a>');
			}
...
echo form_open_multipart('back_office/faq/submit', $attributes); 
...
//ANSWER&nbsp;<em>*</em>: SECTION.
echo form_label('<b>ANSWER&nbsp;<em>*</em>:</b>', 'ANSWER&nbsp;<em>*</em>:');
