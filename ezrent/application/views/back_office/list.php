...
window.location="<?= site_url("back_office//delete"); ?>/"+id;
return false;
}
...
$("#result").load("<?= site_url("back_office//sorted"); ?>"+"?"+ser);
}
});
...
<? if ($this->acl->has_permission('','add')){ ?>
<li class="pull-right">
<a href="<?= site_url('back_office//add'); ?>" id="topLink" class="btn btn-info top_btn" title="">Add </a>
</li><? } ?>
</ul> 
</div>
...
echo form_open_multipart('back_office//delete_all', $attributes); 
?>  		
...
<td width="2%">&nbsp;</td>
<th>
<a href="<?= site_url('back_office//index/title'); ?>" class="<? if($sego == "title") echo 'green'; else echo 'order_link'; ?>" >
TITLE
</a>
...
<td colspan="2">
<? if ($this->acl->has_permission('','delete_all')){ ?>
...
?>
<tr id="<?=$val["id_"]; ?>">
<td class="col-chk"><input type="checkbox" name="cehcklist[]" value="<?= $val["id_"] ; ?>" /></td>
<td class="title_search">
<? echo $val["title".$lang]; ?>
</td>
<td style="text-align:center"><? if ($this->acl->has_permission('','index')){ ?>
<a href="<?= site_url('back_office//view/'.$val["id_"]);?>" class="table-edit-link" title="View" >
<i class="icon-search" ></i> View</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('','edit')){ ?>
<a href="<?= site_url('back_office//edit/'.$val["id_"]);?>" class="table-edit-link" title="Edit" >
<i class="icon-edit" ></i> Edit</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('','delete')){ ?>
<a onclick="if(confirm('Are you sure you want delete this item ?')){ delete_row('<?=$val["id_"];?>'); }" class="table-delete-link cur" title="Delete" >
...
<form action="<?= site_url("back_office/"); ?>" method="post"  id="show_items">
Show Items&nbsp;
