...
window.location="<?= site_url("back_office/news/delete"); ?>/"+id;
return false;
}
...
$("#result").load("<?= site_url("back_office/news/sorted"); ?>"+"?"+ser);
}
});
...
<li class="pull-right">
<a href="<?= site_url('back_office/news/add'); ?>" id="topLink" class="btn btn-info top_btn" title="">Add news</a>
</li><? } ?>
</ul> 
</div>
...
echo form_open_multipart('back_office/news/delete_all', $attributes); 
?>  		
...
<td width="2%">&nbsp;</td>
<th>
<a href="<?= site_url('back_office/news/index/title'); ?>" class="<? if($sego == "title") echo 'green'; else echo 'order_link'; ?>" >
TITLE
</a>
</th>
<th>
<a href="<?= site_url('back_office/news/index/is_popular'); ?>" class="<? if($sego == "is_popular") echo 'order_active'; else echo 'order_link'; ?>" >
IS POPULAR
</a>
...
<td><input type="text" name="search" class="search_box" id="is_popular_search" /></td>
<td></td>
</tr>
</thead><tfoot><tr>
...
?>
<tr id="<?=$val["id_news"]; ?>">
<td class="col-chk"><input type="checkbox" name="cehcklist[]" value="<?= $val["id_news"] ; ?>" /></td>
<td class="title_search">
<? echo $val["title".$lang]; ?>
</td>
<td class="is_popular_search">
<? if($val["is_popular"] == 1)
echo "<span class=' label label-success' >Active</span>";
else
echo "<span class=' label label-important ' >InActive</span>";   ?>
</td>
<td style="text-align:center"><? if ($this->acl->has_permission('news','index')){ ?>
<a href="<?= site_url('back_office/news/view/'.$val["id_news"]);?>" class="table-edit-link" title="View" >
<i class="icon-search" ></i> View</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('news','edit')){ ?>
<a href="<?= site_url('back_office/news/edit/'.$val["id_news"]);?>" class="table-edit-link" title="Edit" >
<i class="icon-edit" ></i> Edit</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('news','delete')){ ?>
<a onclick="if(confirm('Are you sure you want delete this item ?')){ delete_row('<?=$val["id_news"];?>'); }" class="table-delete-link cur" title="Delete" >
...
<form action="<?= site_url("back_office/news"); ?>" method="post"  id="show_items">
Show Items&nbsp;
