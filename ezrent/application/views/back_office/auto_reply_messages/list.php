...
window.location="<?= site_url('back_office/auto_reply_messages/delete'); ?>/"+id;
return false;
}
...
$("#result").load("<?= site_url('back_office/auto_reply_messages/sorted'); ?>"+'?'+ser);
}
});
...
<li class="pull-right">
<a href="<?= site_url('back_office/auto_reply_messages/add'); ?>" id="topLink" class="btn btn-info top_btn" title="">Add auto reply messages</a>
</li><? } ?>
</ul> 
</div>
...
echo form_open_multipart('back_office/auto_reply_messages/delete_all', $attributes); 
?>  		
...
$i++; 
?>
<tr id="<?=$val["id_auto_reply_messages"]; ?>">
<td class="col-chk"><input type="checkbox" name="cehcklist[]" value="<?= $val["id_auto_reply_messages"] ; ?>" /></td>
<td class="title_search">
<? echo $val["title".$lang]; ?>
</td>
<td style="text-align:center">
<? if($this->config->item("language_module")) { ?>
<a href="<?= site_url('back_office/translation/section/auto_reply_messages/'.$val["id_auto_reply_messages"]);?>" class="table-edit-link" title="Translate" >
<i class="icon-search" ></i> Translate</a> <span class="hidden"> | </span>
<? }?>
<? if ($this->acl->has_permission('auto_reply_messages','index')){ ?>
<a href="<?= site_url('back_office/auto_reply_messages/view/'.$val["id_auto_reply_messages"]);?>" class="table-edit-link" title="View" >
<i class="icon-search" ></i> View</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('auto_reply_messages','edit')){ ?>
<a href="<?= site_url('back_office/auto_reply_messages/edit/'.$val["id_auto_reply_messages"]);?>" class="table-edit-link" title="Edit" >
<i class="icon-edit" ></i> Edit</a> <span class="hidden"> | </span>
<? } ?>
<? if ($this->acl->has_permission('auto_reply_messages','delete')){ ?>
<a onclick="if(confirm('Are you sure you want delete this item ?')){ delete_row('<?=$val["id_auto_reply_messages"];?>'); }" class="table-delete-link cur" title="Delete" >
...
<form action="<?= site_url("back_office/auto_reply_messages"); ?>" method="post"  id="show_items">
Show Items&nbsp;
