...
<div class="col-lg-6 col-md-6 col-sm-6 customer-action-header">
   <div class="customer-action-hd">
      ...
      <a href="http://localhost/account" title="Create Your Account" target="_blank"><?php $translate->__('Join Free'); ?></a> <?php $translate->__('or');?> <a href="http://localhost/login" title="Sign In" target="_blank"><?php $translate->__('Sign in');?></a> 
   </div>
</div>
   ...
   <div class="toplinks-wrapper">
      <ul class="header links">
         <li class="myaccount-link"><a href="http://localhost/account" title="My Account">
            <?= $translate->__('My Account')?></a></li>
         <li class="link wishlist" data-bind="scope: 'wishlist'">
            <a href="#">
               <?php $translate->__('My Wish List');?> <!-- ko if: wishlist().counter --><span data-bind="text: wishlist().counter" class="counter qty"></span> 
            </a>
         </li>
         <li class="checkout-link"><a href="/checkout" title="Checkout"><?php $translate->__('Checkout');?></a></li>
         <?php if($obj->IsUserLoggedInBuyer() === true ) :?>
         <li class="authorization"><a href="/user-buyer-14e1813e3d0cf9da1a9dafc6afadff37/logout" title="Checkout"><?php $translate->__('LogOut')?></a></li>
         <?php endif;?>
         <li class="authorization-link" data-label="or"><a href="http://localhost/marketplace-theme/themes/sm_market2/argentina/customer/account/login/referer/aHR0cDovL21hZ2VudG8yLmZseXRoZW1lLm5ldC90aGVtZXMvc21fbWFya2V0Mi9hcmdlbnRpbmEvY3VzdG9tZXIvYWNjb3VudC9sb2dpbi8%2C/"><?php $translate->__('Sign In')?></a></li>
      </ul>
   </div>
</div>
</div>
                                                ...
                                                <div class="sm_megamenu_title  ">
                                                   <div data-link="http://localhost/themes/sm_market2/argentina/" class="sm_megamenu_col_6 sm_megamenu_firstcolumn    margin-bottom">
                                                      <div class="sm_megamenu_head_item">
                                                         <div class="sm_megamenu_title  ">
                                                            <div class="sm_megamenu_title">
                                                               <h3 class="sm_megamenu_nodrop  title-cat" id="sm_megamenu_1.1">
                                                               
                                                               <?php $translate->__('Hot Category'); ?> 

                                                            </h3>
                                                            </div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.1.1"><a class="sm_megamenu_nodrop" href="http://localhost/category/dresses/111"><span class="sm_megamenu_title_lv-4">
                                                             <?php $translate->__('Dresses'); ?> 


                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.1.2"><a class="sm_megamenu_nodrop" href="http://localhost/category/hoodies-and-sweatshirts/112"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Hoodies & Sweatshirts'); ?> 
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.1.3"><a class="sm_megamenu_nodrop" href="http://localhost/category/blouses-and-shirts/113"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Blouses & Shirts'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.1.4"><a class="sm_megamenu_nodrop" href="http://localhost/category/t-shirts/114"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('T-Shirts'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.1.5"><a class="sm_megamenu_nodrop" href="http://localhost/category/sweaters/115"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Sweaters'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.1.6"><a class="sm_megamenu_nodrop" href="http://localhost/category/socks-and-hosiery/116"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Socks & Hosiery'); ?>
                                                   ...
                                                   <div data-link="http://localhost/themes/sm_market2/argentina/" class="sm_megamenu_col_6 sm_megamenu_firstcolumn    ">
                                                      <div class="sm_megamenu_head_item">
                                                         <div class="sm_megamenu_title  ">
                                                            ...
                                                            <div class="sm_megamenu_title">
                                                               <h3 class="sm_megamenu_nodrop  title-cat " id="sm_megamenu_1.2">

                                                               <?php $translate->__('Bottoms'); ?>
                                                               

                                                            </h3>
                                                            </div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.2.1"><a class="sm_megamenu_nodrop" href="http://localhost/category/skirts/121"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Skirts'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.2.2"><a class="sm_megamenu_nodrop" href="http://localhost/category/leggins/122"><span class="sm_megamenu_title_lv-4">
                                                            <?php $translate->__('Leggings'); ?>


                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.2.3"><a class="sm_megamenu_nodrop" href="http://localhost/category/jeans/123"><span class="sm_megamenu_title_lv-4">
                                                            
                                                            <?php $translate->__('Jeans'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.2.4"><a class="sm_megamenu_nodrop" href="http://localhost/category/pants-capris/124"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Pants & Capris'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.2.5"><a class="sm_megamenu_nodrop" href="http://localhost/category/wide-leg-pants/125"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Wide Leg Pants'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.2.6"><a class="sm_megamenu_nodrop" href="http://localhost/category/shorts/126"><span class="sm_megamenu_title_lv-4">
                                                            
                                                            <?php $translate->__('Shorts'); ?>
                                                   ...
                                                   <div data-link="http://localhost/themes/sm_market2/argentina/" class="sm_megamenu_col_6 sm_megamenu_firstcolumn    margin-bottom">
                                                      <div class="sm_megamenu_head_item">
                                                         <div class="sm_megamenu_title  ">
                                                            ...
                                                            <div class="sm_megamenu_title">
                                                               <h3 class="sm_megamenu_nodrop  title-cat" id="sm_megamenu_1.3">

                                                               <?php $translate->__('Outerwear & Jackets'); ?>
                                                               

                                                            </h3>
                                                            </div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.3.1"><a class="sm_megamenu_nodrop" href="http://localhost/category/basic-jackets/131"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Basic Jackets'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.3.2"><a class="sm_megamenu_nodrop" href="http://localhost/category/real-fur/132"><span class="sm_megamenu_title_lv-4">
                                                           
                                                            <?php $translate->__('Real Fur'); ?>

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.3.3"><a class="sm_megamenu_nodrop" href="http://localhost/category/down-coat/133"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Down Coats'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.3.4"><a class="sm_megamenu_nodrop" href="http://localhost/category/blazers/134"><span class="sm_megamenu_title_lv-4">

                                                             <?php $translate->__('Blazers'); ?>

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.3.5"><a class="sm_megamenu_nodrop" href="http://localhost/category/trench/135"><span class="sm_megamenu_title_lv-4">

                                                           <?php $translate->__('Trench'); ?>
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.3.6"><a class="sm_megamenu_nodrop" href="http://localhost/category/parkas/136"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Parkas'); ?>
                                                   ...
                                                   <div data-link="http://localhost/themes/sm_market2/argentina/" class="sm_megamenu_col_6 sm_megamenu_firstcolumn    ">
                                                      <div class="sm_megamenu_head_item">
                                                         <div class="sm_megamenu_title  ">
                                                            <a class="sm_megamenu_nodrop " href="http://localhost/themes/sm_market2/argentina/smartphones-tablets/swim-gear.html"></a>
                                                            <div class="sm_megamenu_title">
                                                               <h3 class="sm_megamenu_nodrop  title-cat" id="sm_megamenu_1.4">

                                                                  <?php $translate->__('Tops & Sets'); ?>
                                                               

                                                            </h3>
                                                            </div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.4.1"><a class="sm_megamenu_nodrop" href="http://localhost/category/tank-tops/141"><span class="sm_megamenu_title_lv-4">
                                                           <?php $translate->__('Tank Tops'); ?>


                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.4.2"><a class="sm_megamenu_nodrop" href="http://localhost/category/suits-and-sets/142"><span class="sm_megamenu_title_lv-4">

                                                          <?php $translate->__('Suits & Sets'); ?>  


                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.4.3"><a class="sm_megamenu_nodrop" href="http://localhost/category/jumpsuits/143"><span class="sm_megamenu_title_lv-4">

                                                               <?php $translate->__('Jumpsuits'); ?> 
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.4.4"><a class="sm_megamenu_nodrop" href="http://localhost/category/rompers/144"><span class="sm_megamenu_title_lv-4">

                                                               <?php $translate->__('Rompers'); ?> 
                                                           


                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.4.5"><a class="sm_megamenu_nodrop" href="http://localhost/category/intimates/145"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Intimates'); ?> 
                                                            

                                                         </span></a></div>
                                                            <div class="sm_megamenu_title " id="sm_megamenu_1.4.6"><a class="sm_megamenu_nodrop" href="http://localhost/category/sleep-and-lounge/146"><span class="sm_megamenu_title_lv-4">

                                                            <?php $translate->__('Sleep & Lounge'); ?> 
                                                            ...
                                                            <div data-link="http://localhost/themes/sm_market2/argentina/" class="sm_megamenu_col_6 sm_megamenu_firstcolumn    margin-bottom">
                                                               <div class="sm_megamenu_head_item">
                                                                  <div class="sm_megamenu_title  ">
                                                                     <a class="sm_megamenu_nodrop " href="http://localhost/themes/sm_market2/argentina/smartphones-tablets/cycling-gear.html"></a>
                                                                     <div class="sm_megamenu_title">
                                                                        <h3 class="sm_megamenu_nodrop  title-cat" id="sm_megamenu_1.5">

                                                      <?php $translate->__('Weddings & Events'); ?> 
                                                                        

                                                                     </h3>
                                                                     </div>
                                                                     <div class="sm_megamenu_title " id="sm_megamenu_1.5.1"><a class="sm_megamenu_nodrop" href="http://localhost/category/wedding-dresses/151"><span class="sm_megamenu_title_lv-4">

                                                                     <?php $translate->__('Wedding Dresses'); ?> 
                                                                     

                                                                  </span></a></div>
                                                                     <div class="sm_megamenu_title " id="sm_megamenu_1.5.2"><a class="sm_megamenu_nodrop" href="http://localhost/category/evening-dresses/152"><span class="sm_megamenu_title_lv-4">

                                                                     <?php $translate->__('Evening Dresses'); ?>
                                                                     

                                                                  </span></a></div>
                                                                     <div class="sm_megamenu_title " id="sm_megamenu_1.5.3"><a class="sm_megamenu_nodrop" href="http://localhost/category/prom-dresses/153"><span class="sm_megamenu_title_lv-4">

                                                                     <?php $translate->__('Prom Dresses'); ?>
                                                                     

                                                                  </span></a></div>
                                                                     <div class="sm_megamenu_title " id="sm_megamenu_1.5.4"><a class="sm_megamenu_nodrop" href="http://localhost/category/bridesmai-dresses/154"><span class="sm_megamenu_title_lv-4">

                                                                     <?php $translate->__('Bridesmaid Dresses'); ?>
                                                                     

                                                                  </span></a></div>
                                                                     <div class="sm_megamenu_title " id="sm_megamenu_1.5.5"><a class="sm_megamenu_nodrop" href="http://localhost/category/flower-girl-dresses/155"><span class="sm_megamenu_title_lv-4">

                                                                     
                                                   <?php $translate->__('Flower Girl Dresses'); ?>

                                                                  </span></a></div>
                                                                     <div class="sm_megamenu_title " id="sm_megamenu_1.5.6"><a class="sm_megamenu_nodrop" href="http://localhost/category/coctail-dresses/156"><span class="sm_megamenu_title_lv-4">

                                                                     <?php $translate->__('Cocktail Dresses'); ?>
                                                         ...
                                                         <div data-link="http://localhost/themes/sm_market2/argentina/" class="sm_megamenu_col_6 sm_megamenu_firstcolumn    ">
                                                            <div class="sm_megamenu_head_item">
                                                               <div class="sm_megamenu_title  ">
                                                                  <a class="sm_megamenu_nodrop " href="http://localhost/themes/sm_market2/argentina/smartphones-tablets/swim-gear.html"></a>
                                                                  <div class="sm_megamenu_title">
                                                                     <h3 class="sm_megamenu_nodrop  title-cat" id="sm_megamenu_1.6">
                                                                     <?php $translate->__('Accessories
'); ?>
                                                                     

                                                                  </h3>
                                                                  </div>
                                                                  <div class="sm_megamenu_title " id="sm_megamenu_1.6.1"><a class="sm_megamenu_nodrop" href="http://localhost/category/eyewear-and-accessories/161"><span class="sm_megamenu_title_lv-4">

                                                                  <?php $translate->__('Eyewear & Accessories'); ?>
                                                                  


                                                               </span></a></div>
                                                                  <div class="sm_megamenu_title " id="sm_megamenu_1.6.2"><a class="sm_megamenu_nodrop" href="http://localhost/categoryhats-and-caps/162"><span class="sm_megamenu_title_lv-4">
                                                                  
                                                                  <?php $translate->__('Hats & Caps'); ?>

                                                               </span></a></div>
                                                                  <div class="sm_megamenu_title " id="sm_megamenu_1.6.3"><a class="sm_megamenu_nodrop" href="http://localhost/category/belts-and-cummerbunds/163"><span class="sm_megamenu_title_lv-4">

                                                                  <?php $translate->__('Belts & Cummerbunds'); ?>
                                                                  

                                                               </span></a></div>
                                                                  <div class="sm_megamenu_title " id="sm_megamenu_1.6.4"><a class="sm_megamenu_nodrop" href="http://localhost/category/scares-and-wraps/164"><span class="sm_megamenu_title_lv-4">

                                                                  
                                                                     <?php $translate->__('Scarves & Wraps'); ?>
                                                               </span></a></div>
                                                                  <div class="sm_megamenu_title " id="sm_megamenu_1.6.5"><a class="sm_megamenu_nodrop" href="http://localhost/category/gloves-and-mittens/165"><span class="sm_megamenu_title_lv-4">

                                                                  <?php $translate->__('Gloves & Mittens'); ?>

                                                                  


                                                               </span></a></div>
                                                                  <div class="sm_megamenu_title " id="sm_megamenu_1.6.6"><a class="sm_megamenu_nodrop" href="http://localhost/category/prescription-glasses/166"><span class="sm_megamenu_title_lv-4">

                                                                  <?php $translate->__('Prescription Glasses'); ?>
                                                   ...
                                                   <div data-link="http://localhost/themes/sm_market2/argentina/" class="sm_megamenu_col_6 sm_megamenu_firstcolumn  margin-bottom">
                                                      <div class="sm_megamenu_head_item">
                                                         <div class="sm_megamenu_title  ">
                                                            ...
                                                            <div class="sm_megamenu_title " id="sm_megamenu_7.5.2" <a="" href="http://localhost/category/ballons/752"><span class="sm_megamenu_title_lv-4">Ballons</span>
                                                         </div>
...
<div id="sm_searchbox14897965901524390218" class="sm-searchbox">
   <div class="sm-searchbox-content">
      <form class="form minisearch" id="searchbox_mini_form" action="/search" method="get">
         <div class="actions">
            <button "type="submit" title="Search" class="btn-searchbox" ><span>
            
            <?php $translate->__('Search'); ?>
         </span></button>
         </div>

         <div class="field searchbox">
            <div class="control">
<select class="cat searchbox-cat" name="cat" dir = "right">
                  <option value=""><?php $translate->__('All Categories'); ?> </option>
                  <option value="1">- - <?php $translate->__('womens Clothing'); ?> </option>
                  <option value="11">- - - - <?php $translate->__('Hot Category'); ?> </option>
                  <option value="12">- - - - <?php $translate->__('Bottoms'); ?> </option>
                  <option value="13">- - - - <?php $translate->__('Outwear & Jackets'); ?> </option>
                  <option value="14">- - - - <?php $translate->__('Tops & Sets'); ?> </option>
                  <option value="15">- - - - <?php $translate->__('Weddings & Events'); ?>  </option>
                  <option value="16">- - - - <?php $translate->__('Accessories'); ?> </option>
                  <option value="2">- - <?php $translate->__('Mens Clothing'); ?> </option>
                  <option value="21">- - - - <?php $translate->__('Hot Sale'); ?></option>
                  <option value="22">- - - -  <?php $translate->__('Bottoms'); ?></option>
                  <option value="23">- - - -  <?php $translate->__('Outerwear & Jackets'); ?></option>
                  <option value="24">- - - - <?php $translate->__('Underwear & Loungewear'); ?> </option>
                  <option value="25">- - - - <?php $translate->__('Accessories'); ?> </option>
                  <option value="26">- - - - <?php $translate->__('Novelty & Special Use'); ?> </option>
                  <option value="3">- - <?php $translate->__('Phones & Accessories'); ?> </option>
                  <option value="31">- - - -  <?php $translate->__('Mobile Phones'); ?> </option>
                  <option value="32">- - - - <?php $translate->__('Mobile Phone Parts'); ?> </option>
                  <option value="33">- - - - <?php $translate->__('Cases & Covers'); ?> </option>
                  <option value="34">- - - -  <?php $translate->__('Mobile Phone Accessories'); ?></option>
                  <option value="35">- - - -  <?php $translate->__('Hot Categories'); ?></option>
                  <option value="4">- -  <?php $translate->__('Computer,Office,Security'); ?></option>
                  <option value="41">- - - -  <?php $translate->__('Laptop & Tablets'); ?></option>
                  <option value="42">- - - - <?php $translate->__('Tablet & Laptop Accessories'); ?> </option>
                  <option value="43">- - - - <?php $translate->__('Security & Protection'); ?></option>
                  <option value="44">- - - - <?php $translate->__('Storage Devices'); ?></option> </option>
                  <option value="45">- - - - <?php $translate->__('Office Electronics'); ?> </option>
                  <option value="46">- - - - <?php $translate->__('Networking'); ?> </option>
                  <option value="5">- - <?php $translate->__('Consumer Electronics'); ?> </option>
                  <option value="51">- - - - <?php $translate->__('Accessories & Parts'); ?>  </option>
                  <option value="52">- - - - <?php $translate->__('Home Audio & Video'); ?> </option>
                  <option value="53">- - - -  <?php $translate->__('Camera & Photo'); ?></option>
                  <option value="54">- - - - <?php $translate->__('Portable Audio & Video'); ?> </option>
                  <option value="55">- - - - <?php $translate->__('Smart Electronics'); ?></option>
                  <option value="56">- - - - <?php $translate->__('Video Games'); ?> </option>
                  <option value="6">- -  <?php $translate->__('Jewelry & Watches'); ?></option>
                  <option value="61">- - - - <?php $translate->__('Fine Jewelry'); ?> </option>
                  <option value="62">- - - - <?php $translate->__('Wedding & Engagement'); ?></option>
                  <option value="63">- - - - <?php $translate->__('Mens Watches'); ?></option>
                  <option value="64">- - - - <?php $translate->__('Womens Watches'); ?></option>
                  <option value="65">- - - - <?php $translate->__('Fashion Jewelry'); ?></option>
                  <option value="66">- - - - <?php $translate->__('Beads & DIY Jewelry'); ?></option>
                  <option value="7">- - <?php $translate->__('Home,Garden & Furniture'); ?></option>
                  <option value="71">- - - - <?php $translate->__('Arts'); ?></option>
                  <option value="72">- - - - <?php $translate->__('Home Deco'); ?></option>
                  <option value="73">- - - - <?php $translate->__('Home Textile'); ?></option>
                  <option value="74">- - - -<?php $translate->__('Festivals'); ?></option>
                  <option value="75">- - - - <?php $translate->__('Household Merchandises'); ?></option>
                  <option value="76">- - - - <?php $translate->__('Home Storage'); ?></option>
                  <option value="77">- - - - <?php $translate->__('Kitchen'); ?></option>
                  <option value="78">- - - - <?php $translate->__('Garden Supplies'); ?></option>
                  <option value="79">- - - - <?php $translate->__('Home Appliances'); ?></option>
                  <option value="8">- - <?php $translate->__('Bags & shoes'); ?></option>
                  <option value="81">- - - - <?php $translate->__('Womens Luggage & Bags'); ?></option>
                  <option value="82">- - - - <?php $translate->__('Womens Shoess'); ?></option>
                  <option value="83">- - - - <?php $translate->__('Mens Luggage &amp; Bags'); ?></option>
                  <option value="84">- - - -<?php $translate->__('Mens Shoes'); ?></option>
                  <option value="85">- - - - <?php $translate->__('Other Bags & Accessories'); ?></option>
                  <option value="86">- - - - <?php $translate->__('Bestselling Shoes'); ?></option>
                  <option value="9">- - <?php $translate->__('Toys, Kids &amp; Baby'); ?></option>
                  <option value="91">- - - - <?php $translate->__('Baby Clothing'); ?></option>
                  <option value="92">- - - - <?php $translate->__('Toys & Hobbies'); ?></option>
                  <option value="93">- - - - <?php $translate->__('Girls Clothing'); ?></option>
                  <option value="94">- - - -<?php $translate->__('Shoes & Bags'); ?></option>
                  <option value="95">- - - - <?php $translate->__('Boys Clothing'); ?></option>
                  <option value="96">- - - - <?php $translate->__('Baby & Mother'); ?></option>
                  <option value="10">- - <?php $translate->__('Sports & Outdoors'); ?></option>
                  <option value="101">- - - - <?php $translate->__('Swimmings'); ?></option>
                  <option value="102">- - - - <?php $translate->__('Cycling'); ?></option>
                  <option value="103">- - - - <?php $translate->__('Sneakers'); ?></option>
                  <option value="104">- - - -<?php $translate->__('Fishing'); ?></option>
                  <option value="105">- - - - <?php $translate->__('Sportswear'); ?></option>
                  <option value="106">- - - - <?php $translate->__('Other Sports Equipment'); ?></option>
                  <option value="11">- - <?php $translate->__('Health,Beauty & Hair'); ?></option>
                  <option value="111">- - - - <?php $translate->__('Human Hair Weaves'); ?></option>
                  <option value="112">- - - -<?php $translate->__('Wigs & Salon Supply'); ?></option>
                  <option value="113">- - - - <?php $translate->__('Makeup'); ?></option>
                  <option value="114">- - - -<?php $translate->__('Nail Art & Tools'); ?></option>
                  <option value="115">- - - - <?php $translate->__('Beauty Tools'); ?></option>
                  <option value="116">- - - - <?php $translate->__('Skin care'); ?></option>
                  <option value="12">- - <?php $translate->__('Automobiles & Motorcycle'); ?></option>
                  <option value="121">- - - - <?php $translate->__('Auto Replacement Parts'); ?></option>
                  <option value="122">- - - -<?php $translate->__('Tools, Maintenance'); ?> &amp; Care</option>
                  <option value="123">- - - - <?php $translate->__('Car Electronics'); ?></option>
                  <option value="124">- - - -<?php $translate->__('Exterior Accessories'); ?></option>
                  <option value="125">- - - - <?php $translate->__('Motorcycle Accessories & Parts'); ?></option>
                  <option value="126">- - - - <?php $translate->__('Interior Accessories'); ?></option>
                  <option value="13">- - <?php $translate->__('Home Improvment,Tools'); ?></option>
                  <option value="131">- - - - <?php $translate->__('Tools'); ?></option>
                  <option value="132">- - - -<?php $translate->__('Indoor Lighting'); ?></option>
                  <option value="133">- - - - <?php $translate->__('Tools<'); ?>/option>
                  <option value="134">- - - -<?php $translate->__('LED Lighting'); ?></option>
                  <option value="135">- - - - <?php $translate->__('Home Improvements'); ?></option>
                  <option value="136">- - - - <?php $translate->__('Jewelry & Watches'); ?><?php $translate->__('Outdoor Lighting'); ?></option>
                  <option value="112">- - <?php $translate->__('About Us'); ?></option>
                  <option value="113">- - <?php $translate->__('Contact Us'); ?></option>
                  <option value="205">- - <?php $translate->__('Product Types'); ?></option>
               </select>
